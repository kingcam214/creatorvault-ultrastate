...
import RecruiterOSCommandCenter from "./pages/RecruiterOSCommandCenter";
import ConversionEngineCommandCenter from "./pages/ConversionEngineCommandCenter";
import DailyRevenueEngineCommandCenter from "./pages/DailyRevenueEngineCommandCenter";
...
function Router() {
  ...
  return (
    <>
      ...
      <Route path={"/recruiter-os"} component={RecruiterOSCommandCenter} />
      <Route path={"/conversion-engine"} component={ConversionEngineCommandCenter} />
      <Route path={"/daily-revenue-engine"} component={DailyRevenueEngineCommandCenter} />
      ...
      <Route path={"/font-library"} component={FontLibrary} />
            ...
            <Route path={"/owner-cockpit/recruiter-os"} component={RecruiterOSCommandCenter} />
            <Route path={"/owner-cockpit/conversion-engine"} component={ConversionEngineCommandCenter} />
            <Route path={"/owner-cockpit/daily-revenue-engine"} component={DailyRevenueEngineCommandCenter} />
      ...
      <Route path="/checkout/recover" component={CheckoutRecovery} />
