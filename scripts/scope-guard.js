...
const ALLOWLISTS = {
  ...
  'kingcam-clone-operating-system': [
    ...
    'workers/kingcam-performer/app/main.py',
    'workers/kingcam-performer/app/patch_wan_bf16.py',
    'workers/kingcam-performer/app/wan_animate_2_performer.yaml',
  ...
  'caption-stage': [
    ...
    'shared/captionEngineIntelligence.ts',
    'shared/captionEnginePresentation.ts',
    'shared/captionEngineQuality.ts',
    'scripts/verify-caption-stage-render.ts',
    'scripts/render-caption-engine-supreme-proof.ts',
    'scripts/test-caption-engine-intelligence.ts',
    'scripts/test-caption-engine-presentation.ts',
    'scripts/test-caption-engine-quality.ts',
