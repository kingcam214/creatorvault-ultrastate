...
async function startServer() {
  ...
  app.get("/__release", (_req, res) => {
    ...
    res.json({
      ...
      gitSha: process.env.RELEASE_GIT_SHA || release.gitSha || release.git_sha || release.commit || null,
      builtAt: process.env.RELEASE_BUILT_AT || release.builtAt || release.built_at || release.timestamp || null,
      deployedAt: process.env.RELEASE_DEPLOYED_AT || release.deployedAt || release.deployed_at || release.timestamp || null,
