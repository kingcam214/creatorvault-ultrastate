import{_ as s,g as U,s as q,a as H,b as K,q as V,p as Z,l as w,c as j,D as J,H as Q,K as X,e as Y,y as ee,F as te}from"./mermaid.core-CQmY9M-z.js";import{p as ae}from"./chunk-4BX2VUAB-QwE1M-kF.js";import{p as re}from"./treemap-KMMF4GRG-B8ieHfkc.js";import{d as G,o as ie,a as se}from"./charts-PgCfreOm.js";import"./index-CFc3tnUN.js";import"./trpc-HbxloWEE.js";import"./vendor-Bce9NwRC.js";import"./ui-B6F1G1x3.js";import"./stripe-Bwk3HUG7.js";import"./socket-CG1tBJBN.js";import"./datefns-DSEb2pH2.js";import"./min-CcrNZ2BB.js";import"./_baseUniq-hnz9ownQ.js";var oe=te.pie,D={sections:new Map,showData:!1},g=D.sections,C=D.showData,le=structuredClone(oe),ne=s(()=>structuredClone(le),"getConfig"),ce=s(()=>{g=new Map,C=D.showData,ee()},"clear"),pe=s(({label:e,value:a})=>{if(a<0)throw new Error(`"${e}" has invalid value: ${a}. Negative values are not allowed in pie charts. All slice values must be >= 0.`);g.has(e)||(g.set(e,a),w.debug(`added new section: ${e}, with value: ${a}`))},"addSection"),de=s(()=>g,"getSections"),ge=s(e=>{C=e},"setShowData"),ue=s(()=>C,"getShowData"),W={getConfig:ne,clear:ce,setDiagramTitle:Z,getDiagramTitle:V,setAccTitle:K,getAccTitle:H,setAccDescription:q,getAccDescription:U,addSection:pe,getSections:de,setShowData:ge,getShowData:ue},me=s((e,a)=>{ae(e,a),a.setShowData(e.showData),e.sections.map(a.addSection)},"populateDb"),fe={parse:s(async e=>{const a=await re("pie",e);w.debug(a),me(a,W)},"parse")},he=s(e=>`
  .pieCircle{
