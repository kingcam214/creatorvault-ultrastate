...
const creators: Creator[] = [
  ...
  },
  {
    ...
    name: "Ady Sanchez",
    handle: "@adyyyyyyyyu",
    handles: ["@adysanchesz", "@SpicyAderly"],
    line: "Dominican force. No borrowed energy.",
    world: "SHE OWNS THE FRAME.",
    pulse: "A high-output Dominican fitness and adult creator with a deep personal content vault, real viral pull, and a public world now being rebuilt from only her verified source material.",
    note: "CreatorVault founding circle · verified source world in construction",
    profileUrl: "https://www.instagram.com/adyyyyyyyyu/",
    image: "/images/creator-pages/aderly-public-source.jpg",
    imagePosition: "center",
    publicPresence: [
      { label: "Current Instagram", handle: "@adyyyyyyyyu", href: "https://www.instagram.com/adyyyyyyyyu/", proof: "Verified public personal creator account" },
      { label: "Existing membership", handle: "@adysanchesz", href: "https://onlyfans.com/adysanchesz", proof: "Existing creator-owned membership path" },
    ],
    colors: { ink: "#12060b", glow: "#ff4f8f", wash: "#ffc0d8", edge: "#ffe0ec" },
    status: "roster",
  },
  {
    slug: "leslie",
