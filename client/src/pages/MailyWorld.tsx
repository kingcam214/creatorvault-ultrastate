  ...
  return (
    <main className="min-h-screen overflow-hidden bg-[#fff9ed] text-[#16164a]">
      ...
      <section className="relative min-h-[100svh] overflow-hidden bg-[#2720ce] text-[#fff9ed]">
        <MailyMotion src={maily.outdoor} className="opacity-80 mix-blend-luminosity" />
        <div className="absolute inset-0 bg-[linear-gradient(125deg,rgba(39,32,206,.78),rgba(39,32,206,.12)_56%,rgba(255,83,146,.35))]" />
