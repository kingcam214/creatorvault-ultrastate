    ...
    <main className="min-h-screen overflow-hidden bg-[#070707] text-white">
      <section className="relative isolate flex min-h-screen items-end overflow-hidden px-5 py-20 sm:px-8">
        ...
        <div className="relative mx-auto w-full max-w-3xl rounded-[2rem] border border-amber-200/20 bg-black/55 p-7 shadow-[0_28px_90px_-48px_rgba(245,158,11,.65)] backdrop-blur-sm sm:p-10">
          ...
          <h1 className="mt-4 text-5xl font-black leading-[0.9] tracking-[-0.07em] sm:text-6xl">This release is not open for sale yet.</h1>
          <p className="mt-6 max-w-2xl text-base leading-relaxed text-zinc-200">CreatorVault will not show a price, take payment, promise access, or claim delivery from a direct link until the complete buyer and creator path is proven.</p>
          <div className="mt-7 rounded-2xl border border-white/10 bg-black/35 p-5">
            ...
            <p className="mt-2 text-sm leading-relaxed text-zinc-300">A direct link cannot turn an unfinished product record into a real sale. Accepted CreatorVault work remains watchable in the proof room only.</p>
          </div>
