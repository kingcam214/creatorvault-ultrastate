  ...
  return (
    <main className="min-h-screen overflow-hidden bg-[#080706] text-white selection:bg-[#f0d18a]/40">
      <section className="relative isolate min-h-[100svh] overflow-hidden border-b border-white/10" aria-label="CreatorVault showcase hero">
        <ShowcaseMotion videoSrc={kingcamHero.livePath} posterSrc={kingcamHero.fallbackAsset} alt="KingCam moving backdrop" className="absolute inset-0" priority />
        <div className="pointer-events-none absolute inset-0 flex items-end justify-center overflow-hidden sm:justify-end">
          <video src={kingcamHero.livePath} poster={kingcamHero.fallbackAsset || undefined} autoPlay loop muted playsInline preload="auto" className="h-full w-full max-w-full object-contain object-bottom sm:w-auto" aria-label="KingCam full-body hero" />
        </div>
        ...
        <div className="relative z-10 mx-auto flex min-h-[100svh] max-w-7xl flex-col px-5 pb-7 pt-6 sm:px-8 sm:pt-8 lg:px-12">
          ...
          <div className="mt-auto max-w-3xl pb-10 pt-40 sm:pb-14 lg:my-auto lg:py-28">
            ...
            <p className="mt-6 max-w-xl text-base leading-relaxed text-zinc-100 sm:text-lg">Bring what&apos;s already yours. Turn it into the kind of drop people pause for, remember, and come back to.</p>
          ...
          <div className="grid gap-3 border-t border-white/15 pt-4 text-[10px] font-black uppercase tracking-[0.16em] text-zinc-200 sm:grid-cols-3 sm:text-xs"><span>Your footage</span><span className="sm:text-center">Your presence</span><span className="sm:text-right">Your moment</span></div>
        </div>
      </section>
      ...
      <section className="relative isolate overflow-hidden border-b border-white/10 bg-[#0b0908]" aria-label="Thumbnail transformation proof">
        ...
        <div className="relative mx-auto max-w-7xl px-5 py-14 sm:px-8 sm:py-20 lg:px-12 lg:py-24">
          <div className="mb-10 flex max-w-3xl flex-col gap-4 lg:mb-14">
            ...
            <p className="max-w-2xl text-base leading-relaxed text-zinc-300 sm:text-lg">Your real footage, taken further. The kind of thumbnail that makes them stop before they scroll past.</p>
          </div>
          ...
          <div className="grid gap-5 lg:grid-cols-[1fr_auto_1fr] lg:items-stretch">
            <div className="relative min-h-[28rem] overflow-hidden rounded-[2rem] border border-white/15 bg-black sm:min-h-[36rem]">
              <ShowcaseMotion videoSrc={campaignSource.livePath} posterSrc={campaignSource.fallbackAsset} alt="Your real moment" className="absolute inset-0" />
              <div className="absolute inset-0 bg-[linear-gradient(180deg,rgba(5,5,5,.08),rgba(5,5,5,.75))]" />
              <div className="absolute inset-x-0 bottom-0 p-6 sm:p-8"><ProofLabel>Before / Your real moment</ProofLabel><p className="mt-3 max-w-xs text-2xl font-black leading-tight">The clip exactly as you caught it.</p></div>
            </div>
            ...
            <div className="relative min-h-[28rem] overflow-hidden rounded-[2rem] border border-[#f3d899]/45 bg-[#13100c] p-2 shadow-[0_35px_100px_-55px_rgba(243,216,153,.65)] sm:min-h-[36rem]">
              ...
              <img src={campaignVisual.livePath} alt="The scroll-stopper" className="relative h-full w-full rounded-[1.55rem] object-cover" />
              <div className="absolute inset-x-2 bottom-2 rounded-b-[1.55rem] bg-[linear-gradient(180deg,transparent,rgba(4,4,4,.88))] p-6 sm:p-8"><div className="flex items-center gap-2"><CheckCircle2 className="h-4 w-4 text-[#f3d899]" /><ProofLabel>After / The scroll-stopper</ProofLabel></div><p className="mt-3 max-w-xs text-2xl font-black leading-tight">The same moment, made impossible to pass.</p></div>
            </div>
          </div>
      ...
      <section className="relative isolate overflow-hidden border-b border-white/10 bg-[#070706]" aria-label="Kinetic text on moving media">
        <ShowcaseMotion videoSrc={campaignMotion.livePath} alt="Words over a moving moment" className="absolute inset-0 opacity-75" />
        ...
        <div className="relative mx-auto flex min-h-[88svh] max-w-7xl items-end px-5 py-14 sm:px-8 sm:py-20 lg:items-center lg:px-12">
          <div className="max-w-4xl">
            ...
            <p className="mt-8 max-w-xl text-base leading-relaxed text-zinc-200 sm:text-lg">Your words belong inside the moment—clear, impossible to miss, and right where the eye lands.</p>
            <div className="mt-10 flex flex-wrap gap-3"><span className="rounded-full border border-white/20 bg-black/35 px-4 py-2 text-xs font-black uppercase tracking-[.16em] text-white backdrop-blur">Made for the phone</span><span className="rounded-full border border-[#f3d899]/45 bg-[#f3d899]/10 px-4 py-2 text-xs font-black uppercase tracking-[.16em] text-[#f3d899] backdrop-blur">Words move with the moment</span></div>
          </div>
        </div>
      </section>
      ...
      <section className="relative isolate overflow-hidden border-b border-white/10 bg-[#07070a]" aria-label="Social Empire proof">
        ...
        <div className="relative mx-auto max-w-7xl px-5 py-14 sm:px-8 sm:py-20 lg:px-12">
          ...
          <div className="mt-12 grid gap-4 lg:grid-cols-[1.1fr_auto_1fr] lg:items-center">
            ...
            <div className="grid gap-3 sm:grid-cols-2"><div className="rounded-2xl border border-fuchsia-300/25 bg-fuchsia-400/5 p-5"><p className="text-[10px] font-black uppercase tracking-[.18em] text-fuchsia-200">Your CreatorVault post</p><p className="mt-3 text-xl font-black">Built around the clip you chose.</p></div><div className="rounded-2xl border border-cyan-300/25 bg-cyan-400/5 p-5"><p className="text-[10px] font-black uppercase tracking-[.18em] text-cyan-200">Your social versions</p><p className="mt-3 text-xl font-black">Ready when you say the word.</p></div><div className="sm:col-span-2 rounded-2xl border border-amber-300/20 bg-amber-300/5 p-5"><p className="text-sm leading-relaxed text-amber-100/85">Nothing gets posted, messaged, or scheduled without you saying so.</p></div></div>
          </div>
